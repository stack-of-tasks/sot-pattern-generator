...
def initZMPRef(robot):
    ...
    robot.comSelector = Selector('comSelector', ['vector', 'ref', robot.com, robot.pg.comref])
...
def initFeetTask(robot):
    robot.selecFeet = Selector('selecFeet', [
        ...
        robot.dynamic.signal(robot.OperationalPointsMap['left-ankle']), robot.pg.leftfootref
    ], [
...
def walkFewSteps(robot):
    robot.pg.parseCmd(
        ":stepseq 0.0 0.1025 0.0 0.17 -0.205 0.0 0.17 0.205 0.0 0.17 -0.205 0.0 0.17 0.205 0.0 0.0 -0.205 0.0")


def walkFewStepsCircular(robot):
    robot.pg.parseCmd(
        ":stepseq 0.0 0.1025 0.0 0.1 -0.205 10.0 0.1 0.205 10.0 0.1 -0.205 10.0 0.1 0.205 10.0 0.0 -0.205 0.0")
