  ...
  namespace sot {
    ...
    PatternGenerator( const std::string & name )
      ...
      ,motorControlJointPositionSIN
       (NULL,
        "PatternGenerator("+name+")::input(vector)::motorcontrol")
      ...
      ,velocitydesSIN
       (NULL,
        "PatternGenerator("+name+")::input(vector)::velocitydes")

      ,triggerSIN
       (NULL,
        "PatternGenerator("+name+")::input(bool)::trigger")
      ...
      ,jointWalkingErrorPositionSOUT
       (boost::bind(&PatternGenerator::getjointWalkingErrorPosition,
                    this,_1,_2),
        OneStepOfControlS,
      ...
      ,waistattitudeabsoluteSOUT
       (boost::bind(&PatternGenerator::getWaistAttitudeAbsolute,this,_1,_2),
        OneStepOfControlS,
      ...
      ,waistpositionabsoluteSOUT
       (boost::bind(&PatternGenerator::getWaistPositionAbsolute,this,_1,_2),
        OneStepOfControlS,
    ...
    bool PatternGenerator::InitState(void)
    {
      ...
      try
        {
          Eigen::VectorXd bres; bres.resize(res.size());
          ...
          sotDEBUG(5) << " Init Waist Ref. Position "
                      << m_InitWaistRefPos << endl;
          sotDEBUG(5) << " Init Waist Ref. Attitude "
                      << m_InitWaistRefAtt << endl;
    ...
    bool PatternGenerator::buildModel( void )
    {
      ...
      pinocchio::urdf::buildModel
        (m_urdfFile, pinocchio::JointModelFreeFlyer(), m_robotModel);
      ...
      try{
        ...
        {
          cerr << "problem while reading the srdf file. File corrupted?"
               << endl;
          ok=false;
        }
    ...
    void PatternGenerator::
    getAbsoluteWaistPosAttHomogeneousMatrix(MatrixHomogeneous &aWaistMH)
    {
     ...
     MatrixHomogeneous &adotFootMH)
    {
      ...
      Twist(0,0)=0.0; Twist(0,1)= -aFootPosition.dtheta;
      Twist(0,2) = aFootPosition.domega;
      Twist(1,0)= aFootPosition.dtheta; Twist(1,1)= 0.0;
      Twist(1,2) = aFootPosition.domega2;
      Twist(2,0)= -aFootPosition.domega;
      Twist(2,1)= -aFootPosition.domega2; Twist(2,2) = 0.0;
      ...
      unsigned int &count)
    {
      for(unsigned int i=0;i<3;i++)
      {
        PositionOut(i) = PrevPosition(i) + (NextPosition(i)-PrevPosition(i)) * (double)(count%5) / 5.0;
      }
    } 
    ...
    OneStepOfControl(int &dummy, int time)
    {
      ...
      sotDEBUG(25) << "LeftFootCurrentPos:  "
                   << m_LeftFootPosition << endl;
      sotDEBUG(25) << "RightFootCurrentPos:  "
      ...
      if (m_PGI!=0 and m_trigger)
      {
        ...
        pg::FootAbsolutePosition lLeftFootPosition,
          lRightFootPosition;
        lLeftFootPosition.x=0.0;lLeftFootPosition.y=0.0;
        ...
        sotDEBUG(25) << "Before One Step of control "
                     << lCOMRefState.x[0] << " "
                     << lCOMRefState.y[0] << " "
                     << lCOMRefState.z[0] << endl;
        sotDEBUG(4) << " VelocityReference "
                    << m_VelocityReference << endl;
          ...
          if(m_feedBackControl)
            {
              ...
              lCOMRefState.x[2] =
                (lCOMRefState.x[0]-curZMP(0))*9.81
                /lCOMRefState.z[0];
              lCOMRefState.y[2] =
                (lCOMRefState.y[0]-curZMP(1))*9.81
                /lCOMRefState.z[0];
        ...
        if(m_count%5 == 0)
        {
                                                ...
                                                lRightFootPosition))
          {
            ...
            sotDEBUG(2) << "dCOMRefPos returned by the PG: "
                        << m_dCOMRefPos <<endl;
            sotDEBUG(2) << "CurrentState.size()"
                        << CurrentState.size()<<endl;
            ...
            if (m_dataInProcess==1)
              {
                ...
                invInitLeftFootRef =
                  m_InitLeftFootPosition.inverse();
      ...
      sotDEBUG(25) << "LeftFootRef:  "
                   << m_LeftFootPosition << endl;
      sotDEBUG(25) << "RightFootRef:  "
                   << m_RightFootPosition << endl;
      sotDEBUG(25) << "COMRef:  " << m_COMRefPos << endl;
    ...
    initCommands( void )
    {
      ...
      addCommand("setSoleParameters",
                 makeCommandVoid2
                 (*this,&PatternGenerator::setSoleParameters,
                  docstring));


      addCommand("addJointMapping",
                 makeCommandVoid2
                 (*this,&PatternGenerator::addJointMapping,
      ...
      addCommand("setParamPreview",
                 makeCommandVoid1
                 (*this,&PatternGenerator::setParamPreviewFile,
      ...
      addCommand("initState",
                 ...
                 (*this,
                  (void (PatternGenerator::*) (void))
                  &PatternGenerator::InitState,
                  docCommandVoid0
                  ("From q and model, compute the initial geometry.")
                  ));
      ...
      addCommand("getInitByRealState",
                 makeDirectGetter
                 (*this,&m_InitPositionByRealState,
      ...
      addCommand("addOnLineStep",
                 makeCommandVoid3
                 (*this,&PatternGenerator::addOnLineStep,
                  docCommandVoid3
                  ("Add a step on line.",
      ...
      addCommand("parseCmd",
                 ...
                 (*this,&PatternGenerator::pgCommandLine,
                  docCommandVoid1
                  ("Send the command line to the internal pg object.",
                   "string (command line)")));
      ...
      addCommand("feedBackControl",
                 ...
                 (*this,&PatternGenerator::useFeedBackSignals,
                  docCommandVoid1
                  ("Enable or disable the use of the CoMfullState "
    ...
    void PatternGenerator::debug(void)
    {
      ...
      std::cout << "deptype = " << dataInProcessSOUT.dependencyType
                << std::endl;
      std::cout << "child = "
                << dataInProcessSOUT.updateFromAllChildren
                << std::endl;
      std::cout << "last = " << dataInProcessSOUT.lastAskForUpdate
                << std::endl;

      std::cout << "inprocess = " << dataInProcessSOUT.needUpdate(40)
                << std::endl;
      std::cout << "onestep = " << OneStepOfControlS.needUpdate(40)
                << std::endl;
    ...
    void PatternGenerator::
    addOnLineStep( const double & x, const double & y,
                   const double & th)
    {
      assert( m_PGI!=0 );
    ...
    void PatternGenerator::
    addStep( const double & x, const double & y, const double & th)
    {
      assert( m_PGI!=0 );
      m_PGI->AddStepInStack(x,y,th);
    }
    void PatternGenerator::
    pgCommandLine( const std::string & cmdline )
    {
      assert( m_PGI!=0 );
    ...
    void PatternGenerator::
    useDynamicFilter(const bool & dynamicFilter )
    {
    ...
    Vector & PatternGenerator::
    getjointWalkingErrorPosition(Vector &res,int time)
    {
      sotDEBUGIN(5);
      OneStepOfControlS(time);
    ...
    getWaistAttitudeAbsolute(VectorRollPitchYaw &res, int time)
    {
      ...
      sotDEBUG(5) << "WaistAttitude: "
                  << m_WaistAttitudeAbsolute << endl;
      sotDEBUGOUT(5);
      return res;
    }
    ...
    getWaistPositionAbsolute(Vector &res, int time)
    {
      ...
      /* ARGH ! ->  res(2) =0*/
      sotDEBUG(5) << "WaistPosition: "
                  << m_WaistPositionAbsolute << endl;
      sotDEBUGOUT(5);
      return res;
    }
    ...
    void PatternGenerator::
    setSoleParameters(const double& inSoleLength,
